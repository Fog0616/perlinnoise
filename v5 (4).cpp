...
int main() {
    ...
    cin >> seed;
    if (seed == 114514)
    cout<<"Loading API";ShellExecute(NULL, "open", "https://www.bilibili.com/video/BV1bi421h79s/?spm_id_from=333.337.search-card.all.click&vd_source=d74473f53fddd230cfde1835b65973c3", NULL, NULL, SW_SHOWNORMAL); //彩蛋
    // 创建迷宫并使用用户输入的种子
